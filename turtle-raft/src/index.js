...
Module['FS_createPath']("/", "art", true, true);
    ...
    loadPackage({"files": [{"filename": "/art/badfont.png", "start": 0, "end": 2112}, {"filename": "/art/book.png", "start": 2112, "end": 2686}, {"filename": "/art/car.ase", "start": 2686, "end": 3844}, {"filename": "/art/car.png", "start": 3844, "end": 4134}, {"filename": "/art/cat.png", "start": 4134, "end": 4282}, {"filename": "/art/cheese.png", "start": 4282, "end": 4419}, {"filename": "/art/coin.png", "start": 4419, "end": 4602}, {"filename": "/art/digsite.png", "start": 4602, "end": 4757}, {"filename": "/art/fish.png", "start": 4757, "end": 4916}, {"filename": "/art/font.png", "start": 4916, "end": 33958}, {"filename": "/art/mouse.png", "start": 33958, "end": 34125}, {"filename": "/art/oldraft.png", "start": 34125, "end": 34314}, {"filename": "/art/player.png", "start": 34314, "end": 34510}, {"filename": "/art/playerdig.png", "start": 34510, "end": 34736}, {"filename": "/art/playerfish.png", "start": 34736, "end": 34928}, {"filename": "/art/playerswim.png", "start": 34928, "end": 35045}, {"filename": "/art/raft.png", "start": 35045, "end": 35146}, {"filename": "/art/teleport.png", "start": 35146, "end": 35331}, {"filename": "/art/terrain1.png", "start": 35331, "end": 35502}, {"filename": "/art/terrain2.png", "start": 35502, "end": 35771}, {"filename": "/art/terrain3.png", "start": 35771, "end": 36047}, {"filename": "/art/terrainmap.png", "start": 36047, "end": 37724}, {"filename": "/art/train.png", "start": 37724, "end": 38050}], "remote_package_size": 38050});

  })();

// end include: /tmp/tmp1dx1zf2g.js
// include: /tmp/tmpq42uhr5t.js

    // All the pre-js content up to here must remain later on, we need to run
    // it.
    if (Module['$ww'] || (typeof ENVIRONMENT_IS_PTHREAD != 'undefined' && ENVIRONMENT_IS_PTHREAD)) Module['preRun'] = [];
    var necessaryPreJSTasks = Module['preRun'].slice();
  // end include: /tmp/tmpq42uhr5t.js
// include: /tmp/tmpd11skm33.js

    if (!Module['preRun']) throw 'Module.preRun should exist because file support used it; did a pre-js delete it?';
    necessaryPreJSTasks.forEach((task) => {
      if (Module['preRun'].indexOf(task) < 0) throw 'All preRun tasks that exist before user pre-js code should remain after; did you replace Module or modify Module.preRun?';
    });
  // end include: /tmp/tmpd11skm33.js
...
var ASM_CONSTS = {
  140336: () => { if (document.fullscreenElement) return 1; },  
 140382: () => { return document.getElementById('canvas').width; },  
 140434: () => { return parseInt(document.getElementById('canvas').style.width); },  
 140502: () => { document.exitFullscreen(); },  
 140529: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 140602: () => { if (document.fullscreenElement) return 1; },  
 140648: () => { return document.getElementById('canvas').width; },  
 ...
 140984: () => { return document.getElementById('canvas').width; },  
 141036: () => { return parseInt(document.getElementById('canvas').style.width); },  
 141104: () => { if (document.fullscreenElement) return 1; },  
 141150: () => { return document.getElementById('canvas').width; },  
 141202: () => { return screen.width; },  
 141227: () => { return window.innerWidth; },  
 141253: () => { return window.innerHeight; },  
 141280: () => { if (document.fullscreenElement) return 1; },  
 141326: () => { return document.getElementById('canvas').width; },  
 141378: () => { return screen.width; },  
 141403: () => { document.exitFullscreen(); },  
 141430: () => { if (document.fullscreenElement) return 1; },  
 141476: () => { return document.getElementById('canvas').width; },  
 141528: () => { return parseInt(document.getElementById('canvas').style.width); },  
 141596: () => { document.exitFullscreen(); },  
 141623: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 141681: () => { return screen.width; },  
 141706: () => { return screen.height; },  
 141732: () => { return window.screenX; },  
 141759: () => { return window.screenY; },  
 141786: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 141839: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 141910: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 141967: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 142223: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 142294: () => { if (document.fullscreenElement) return 1; },  
 142340: () => { return window.innerWidth; },  
 142366: () => { return window.innerHeight; },  
 142393: () => { if (document.pointerLockElement) return 1; }
};
