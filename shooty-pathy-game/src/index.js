...
// end include: /tmp/tmp4cj5df_u.js
// include: /tmp/tmpvs1hun17.js

    // All the pre-js content up to here must remain later on, we need to run
    // it.
    if (Module['$ww'] || (typeof ENVIRONMENT_IS_PTHREAD != 'undefined' && ENVIRONMENT_IS_PTHREAD)) Module['preRun'] = [];
    var necessaryPreJSTasks = Module['preRun'].slice();
  // end include: /tmp/tmpvs1hun17.js
// include: /tmp/tmpzeetsb01.js

    if (!Module['preRun']) throw 'Module.preRun should exist because file support used it; did a pre-js delete it?';
    necessaryPreJSTasks.forEach((task) => {
      if (Module['preRun'].indexOf(task) < 0) throw 'All preRun tasks that exist before user pre-js code should remain after; did you replace Module or modify Module.preRun?';
    });
  // end include: /tmp/tmpzeetsb01.js
...
var ASM_CONSTS = {
  119672: () => { if (document.fullscreenElement) return 1; },  
 119718: () => { return document.getElementById('canvas').width; },  
 119770: () => { return parseInt(document.getElementById('canvas').style.width); },  
 119838: () => { document.exitFullscreen(); },  
 119865: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 119938: () => { if (document.fullscreenElement) return 1; },  
 119984: () => { return document.getElementById('canvas').width; },  
 120036: () => { return screen.width; },  
 120061: () => { document.exitFullscreen(); },  
 120088: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 120221: () => { return window.innerWidth; },  
 120247: () => { return window.innerHeight; },  
 120274: () => { if (document.fullscreenElement) return 1; },  
 120320: () => { return document.getElementById('canvas').width; },  
 120372: () => { return parseInt(document.getElementById('canvas').style.width); },  
 120440: () => { if (document.fullscreenElement) return 1; },  
 120486: () => { return document.getElementById('canvas').width; },  
 120538: () => { return screen.width; },  
 120563: () => { return window.innerWidth; },  
 120589: () => { return window.innerHeight; },  
 120616: () => { if (document.fullscreenElement) return 1; },  
 120662: () => { return document.getElementById('canvas').width; },  
 120714: () => { return screen.width; },  
 120739: () => { document.exitFullscreen(); },  
 120766: () => { if (document.fullscreenElement) return 1; },  
 120812: () => { return document.getElementById('canvas').width; },  
 120864: () => { return parseInt(document.getElementById('canvas').style.width); },  
 120932: () => { document.exitFullscreen(); },  
 120959: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 121017: () => { return screen.width; },  
 121042: () => { return screen.height; },  
 121068: () => { return window.screenX; },  
 121095: () => { return window.screenY; },  
 121122: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 121175: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 121246: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 121303: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 121559: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 121630: () => { if (document.fullscreenElement) return 1; },  
 121676: () => { return window.innerWidth; },  
 121702: () => { return window.innerHeight; },  
 121729: () => { if (document.pointerLockElement) return 1; }
};
