...
Module['FS_createPath']("/", "assets", true, true);
    ...
    loadPackage({"files": [{"filename": "/assets/cheese.png", "start": 0, "end": 812}, {"filename": "/assets/dino.png", "start": 812, "end": 2454}, {"filename": "/assets/events.png", "start": 2454, "end": 4897}, {"filename": "/assets/kingsock.png", "start": 4897, "end": 6108}, {"filename": "/assets/mountain.png", "start": 6108, "end": 8870}, {"filename": "/assets/pirate.png", "start": 8870, "end": 10430}, {"filename": "/assets/sock.png", "start": 10430, "end": 11542}, {"filename": "/assets/stage.png", "start": 11542, "end": 17182}, {"filename": "/assets/thanksyou.png", "start": 17182, "end": 23675}, {"filename": "/assets/thechoosing.png", "start": 23675, "end": 29864}], "remote_package_size": 29864});

  })();

// end include: /tmp/tmpv1xpxjqc.js
// include: /tmp/tmpgk8ifn77.js

    // All the pre-js content up to here must remain later on, we need to run
    // it.
    if (Module['$ww'] || (typeof ENVIRONMENT_IS_PTHREAD != 'undefined' && ENVIRONMENT_IS_PTHREAD)) Module['preRun'] = [];
    var necessaryPreJSTasks = Module['preRun'].slice();
  // end include: /tmp/tmpgk8ifn77.js
// include: /tmp/tmppqj4jp5u.js

    if (!Module['preRun']) throw 'Module.preRun should exist because file support used it; did a pre-js delete it?';
    necessaryPreJSTasks.forEach((task) => {
      if (Module['preRun'].indexOf(task) < 0) throw 'All preRun tasks that exist before user pre-js code should remain after; did you replace Module or modify Module.preRun?';
    });
  // end include: /tmp/tmppqj4jp5u.js
...
var ASM_CONSTS = {
  125680: () => { if (document.fullscreenElement) return 1; },  
 125726: () => { return document.getElementById('canvas').width; },  
 125778: () => { return parseInt(document.getElementById('canvas').style.width); },  
 125846: () => { document.exitFullscreen(); },  
 125873: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 125946: () => { if (document.fullscreenElement) return 1; },  
 125992: () => { return document.getElementById('canvas').width; },  
 126044: () => { return screen.width; },  
 126069: () => { document.exitFullscreen(); },  
 126096: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 126229: () => { return window.innerWidth; },  
 126255: () => { return window.innerHeight; },  
 126282: () => { if (document.fullscreenElement) return 1; },  
 126328: () => { return document.getElementById('canvas').width; },  
 126380: () => { return parseInt(document.getElementById('canvas').style.width); },  
 126448: () => { if (document.fullscreenElement) return 1; },  
 126494: () => { return document.getElementById('canvas').width; },  
 126546: () => { return screen.width; },  
 126571: () => { return window.innerWidth; },  
 126597: () => { return window.innerHeight; },  
 126624: () => { if (document.fullscreenElement) return 1; },  
 126670: () => { return document.getElementById('canvas').width; },  
 126722: () => { return screen.width; },  
 126747: () => { document.exitFullscreen(); },  
 126774: () => { if (document.fullscreenElement) return 1; },  
 126820: () => { return document.getElementById('canvas').width; },  
 126872: () => { return parseInt(document.getElementById('canvas').style.width); },  
 126940: () => { document.exitFullscreen(); },  
 126967: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 127025: () => { return screen.width; },  
 127050: () => { return screen.height; },  
 127076: () => { return window.screenX; },  
 127103: () => { return window.screenY; },  
 127130: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 127183: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 127254: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 127311: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 127567: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 127638: () => { if (document.fullscreenElement) return 1; },  
 127684: () => { return window.innerWidth; },  
 127710: () => { return window.innerHeight; },  
 127737: () => { if (document.pointerLockElement) return 1; }
};
